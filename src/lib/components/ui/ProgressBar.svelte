...
<div
	class={`lg:rounded-md border-black border-2 focus:outline-hidden h-9 overflow-hidden shadow-[2px_2px_0px_rgba(0,0,0,1)] bg-white ${disabled ? 'border-[#727272] bg-[#D4D4D4] text-[#676767] hover:bg-[#D4D4D4] hover:shadow-none active:bg-[#D4D4D4]' : 'shadow-[2px_2px_0px_rgba(0,0,0,1)]'}`}
