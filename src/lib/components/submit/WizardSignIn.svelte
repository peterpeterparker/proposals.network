...
<h2 class="text-2xl mb-6">
	Let's face it, command line tools sucks!  But fear not, I've got you covered. Submit motion proposals for the Internet Computer's network nervous system using this user-friendly editor.
</h2>
